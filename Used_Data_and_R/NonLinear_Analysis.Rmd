...
gam_rec_new <- gam_rec %>%
     step_ns(case_rate, deg_free = 10) %>% 
     step_ns(hospitalized_rate, deg_free = 20) %>%
     step_ns(emp_incq1, deg_free = 20) %>% 
     step_ns(emp_incq2, deg_free = 20) %>%
     step_ns(emp_incq3, deg_free = 20) %>% 
     step_ns(emp_incq4, deg_free = 10) %>% 
     step_ns(spend_remoteservices, deg_free = 10) 
```
