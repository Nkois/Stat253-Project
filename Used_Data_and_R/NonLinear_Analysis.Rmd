...
gam_rec_new <- gam_rec %>%
     ...
     step_ns(hospitalized_rate, deg_free = 6) %>%
     step_ns(emp_incq1, deg_free = 100) %>% 
     step_ns(emp_incq2, deg_free = 100) %>%
     step_ns(emp_incq3, deg_free = 100) %>% 
     step_ns(emp_incq4, deg_free = 100) %>% 
