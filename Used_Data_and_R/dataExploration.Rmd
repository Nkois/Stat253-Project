...
The predictor that is most important to determining gps_away_from_home is hospitalized_rate, which is the amount of new patients currently hospitalized in an inpatient bed who have suspected or confirmed COVID-19 per 100,000 people, seven day moving average. This relationship is not too suprising, because hospitalization rates would greatly impact the surrounding communities willingness to be out of the house, depending on the ideology of each community. However, for communities with some common sense, it would follow that hospitalization rates will impact movement outside the house. Spending on remote services is another important predictor of our outcome variable. 
